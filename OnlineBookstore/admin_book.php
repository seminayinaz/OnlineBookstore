<?php
	...
	$result = getAll($conn);
?>
	<h4 class="fw-bolder text-center">Kitap Listesi</h4>
	<center>
			...
			<div class="container-fluid">
				...
				<colgroup>
					...
					<tr>
						...
						<td class="px-2 py-1 align-middle"><?php echo getCategoryName($conn, $row['categoryid']); ?></td>
						<td class="px-2 py-1 align-middle text-center">
							<div class="btn-group btn-group-sm">
								...
								<a href="admin_delete.php?bookisbn=<?php echo $row['book_isbn']; ?>" class="btn btn-sm rounded-0 btn-danger" title="Delete" onclick="if(confirm('Bu kitabı silmek istediğinizden emin misiniz?') === false) event.preventDefault()">
